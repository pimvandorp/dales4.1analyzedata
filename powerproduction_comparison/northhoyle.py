...
row1 = np.array([27,22,17,12,7,2])
row2 = np.array([27,22,17,12,7,2])+1
row3 = np.array([27,22,17,12,7,2])+2
rows = np.zeros((6,3))
rows[:,0] = row1
rows[:,1] = row2
rows[:,2] = row3
...
for stab in ['neutral', 'vu']:
    obsdata = np.loadtxt('./northhoyle_ALBLAS/349_%s.txt' % stab)
    obsdata_lower = np.loadtxt('./northhoyle_ALBLAS/349_%s_lower.txt' % stab)
    obsdata_upper = np.loadtxt('./northhoyle_ALBLAS/349_%s_upper.txt' % stab)
